 ...
 * @author Shai Almog
 */
public class GoogleMapsTestAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "GoogleMapsTestApp";
    ...
    private GoogleMapsTestApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new GoogleMapsTestAppStub());
    }
